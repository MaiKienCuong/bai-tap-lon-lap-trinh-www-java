...
<body>
	...
	<div class="container">
		...
		<div class="text-success">
			<h2>Nhóm 17: Website giới thiệu và bán quần áo trẻ em trực tuyến</h2>
		</div>
		<hr>
		<div class="">
			<h2>Back-end được viết theo kiến trúc Spring-MVC</h2>

			<h2>Front-end được viết bằng React-JS</h2>
		</div>
		<hr>
		<div>
		...
		<hr>
		<div>
			<h2 class="text-danger">Kết nối database:</h2>
			<ul style="font-size: 150%">
				<li>usrename: <strong>sa</strong></li>
				<li>password: <strong>sapassword</strong>
				</li>
			</ul>
